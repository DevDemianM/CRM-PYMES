...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('usuarios', {
      ...
      intentosFallidos: { type: Sequelize.INTEGER, allowNull: false, defaultValue: 0, field: 'intentos_fallidos' },
      bloqueadoHasta: { type: Sequelize.DATE, allowNull: true, field: 'bloqueado_hasta' },
